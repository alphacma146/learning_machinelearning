import pickle
import numpy as np
from .layers import Relu, SoftmaxWithLoss, Dropout, Convolution, Pooling, Affine
...
class DeepConvNet:
    ...
    def __init__(
        ...
        for idx, conv_param in enumerate(
            ...
            self.params[f'W{idx}'] = weight_init_scales[idx] * np.random.randn(
                conv_param['filter_num'],
                pre_channel_num,
                conv_param['filter_size'],
                conv_param['filter_size']
            )
            self.params[f'b{idx}'] = np.zeros(conv_param['filter_num'])
    ...
    def gradient(self, x, t):
        ...
        for i, layer_idx in enumerate(
            ...
            grads[f'W{i}'] = self.layers[layer_idx].dW
            grads[f'b{i}'] = self.layers[layer_idx].db
    ...
    def load_params(self, file_name="params.pkl"):
        ...
        for i, layer_idx in enumerate(
            ...
            self.layers[layer_idx].W = self.params[f'W{i}']
            self.layers[layer_idx].b = self.params[f'b{i}']
